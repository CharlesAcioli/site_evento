...
<p><a href="../eventos/cadastarevento.php">Cadastrar Novo Evento</a></p>
    ...
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <?php foreach ($eventos as $e): ?>
            <tr>
                ...
                <td>
                    <a href="../eventos/editar.php?id=<?= $e['id'] ?>">Editar</a> | 
                    <form action="../eventos/excluir.php" method="post" style="display:inline;" onsubmit="return confirm('Confirma exclusão do evento?');">
